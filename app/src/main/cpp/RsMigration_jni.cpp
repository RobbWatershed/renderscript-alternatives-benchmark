...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_android_example_rsmigration_VulkanImageProcessor_resize(JNIEnv * /* env */,
                                                                 jobject /* this */,
                                                                 jlong _processor,
                                                                 jfloat _percent,
                                                                 jfloat _method,
                                                                 jint _outputIndex) {
    if (_processor == 0L) return false;
    return castToImageProcessor(_processor)->resize(_percent, _method, _outputIndex);
}
