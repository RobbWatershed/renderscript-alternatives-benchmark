    ...
    const std::vector<VkDescriptorPoolSize> descriptorPoolSizes = {
            {
                    ...
                    // We have 4 pipelines, each need 1 combined image sampler descriptor.
                    .descriptorCount = 3,
            },
            {
                    .type = VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,
                    // We have 4 pipelines, each need 1 storage image descriptor.
                    .descriptorCount = 5,
            },
            {
                    .type = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER,
                    // We have 4 pipelines, each need 1 uniform buffer.
                    .descriptorCount = 4,
            },
    };
